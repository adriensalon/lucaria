...
private:
    ...
    detail::container_cache<detail::object_mesh>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
    {
        ...
        detail::container_cache<detail::object_mesh>* _cached_cell = _mappings.objects.meshes.get(_asset_id);
