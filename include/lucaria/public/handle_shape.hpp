...
private:
    ...
    detail::container_cache<detail::object_shape>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
    {
        ...
        detail::container_cache<detail::object_shape>* _cached_cell = _mappings.objects.shapes.get(_asset_id);
