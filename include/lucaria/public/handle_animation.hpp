...
private:
    ...
    detail::assets_cell<detail::object_animation>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
    {
        ...
        detail::assets_cell<detail::object_animation>* _cached_cell = _mappings.objects.animations.get(_asset_id);
