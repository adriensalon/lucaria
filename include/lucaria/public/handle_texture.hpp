...
private:
    ...
    detail::container_cache<detail::object_texture>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
	{
        ...
        detail::container_cache<detail::object_texture>* _cached_cell = _mappings.objects.textures.get(_asset_id);
