...
private:
    ...
    detail::container_cache<detail::object_image>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
    {
        ...
        detail::container_cache<detail::object_image>* _cached_cell = _mappings.objects.images.get(_asset_id);
