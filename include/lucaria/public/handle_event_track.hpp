...
// private:
    ...
    detail::assets_cell<detail::object_event_track>* _cached = nullptr;
    ...
    void load(ArchiveType& archive)
    {
        ...
        detail::assets_cell<detail::object_event_track>* _cached_cell = _mappings.objects.event_tracks.get(_asset_id);
