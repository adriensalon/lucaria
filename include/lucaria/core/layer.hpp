...
namespace detail {
    ...
    constexpr std::int16_t bulletgroupID_collider_layer_3 = 1 << 6; // interacts with kinematic_rigidbody
    constexpr std::int16_t bulletgroupID_collider_layer_4 = 1 << 7; // interacts with kinematic_rigidbody
    constexpr std::int16_t bulletgroupID_collider_layer_5 = 1 << 8; // interacts with kinematic_rigidbody
    constexpr std::int16_t bulletgroupID_collider_layer_6 = 1 << 9; // interacts with kinematic_rigidbody
    constexpr std::int16_t bulletgroupID_collider_layer_7 = 1 << 10; // interacts with kinematic_rigidbody
    constexpr std::int16_t bulletgroupID_collider_layer_8 = 1 << 11; // interacts with kinematic_rigidbody
}
