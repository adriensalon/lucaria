...
namespace detail {
    ...
    namespace {
        ...
        // container_async<object_program> _fetch_program_async(manager_assets& fetches, const std::filesystem::path& vertex_data_path, const std::filesystem::path& fragment_data_path)
        // {
        ...
        //     return container_async<object_program>(_shaders_promise->get_future(), [](const std::pair<object_shader, object_shader>& _from) {
