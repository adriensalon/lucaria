...
namespace detail {
    ...
    namespace {
        ...
        // container_async<object_program> _fetch_program_async(manager_object& fetches, const std::filesystem::path& vertex_data_path, const std::filesystem::path& fragment_data_path)
        // {
