...
namespace detail {
    ...
    namespace {
        ...
        // assets_async_slot<rendering_program> _fetch_program_async(manager_assets& fetches, const std::filesystem::path& vertex_data_path, const std::filesystem::path& fragment_data_path)
        // {
        ...
        //     return assets_async_slot<rendering_program>(_shaders_promise->get_future(), [](const std::pair<object_shader, object_shader>& _from) {
        //         return rendering_program(_from.first, _from.second);
        //     });
        // }
