...
constexpr short bulletgroupID_collider_layer_1 = 1 << 4; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_2 = 1 << 5; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_3 = 1 << 6; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_4 = 1 << 7; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_5 = 1 << 8; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_6 = 1 << 9; // interacts with kinematic_rigidbody
constexpr short bulletgroupID_collider_layer_7 = 1 << 10; // interacts with kinematic_rigidbody
